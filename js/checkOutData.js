...
for(let i=0;i<countries.length;i++){
            ...
            for(let j=0;j<items.length;j++){
                    ...
                    if(countries[i] == localStorage.getItem( items[j] + countries[i][0])){
                        strD += '<ul style="list-style:none;margin-left:10px;margin-right:10px;padding:0 5px;background:rgba(255,255,255,0.6);width:80%;diplay:flex;float:left;">';
...
priceData.innerHTML = '<h4 style="font-size:18px; font-weight:600;padding-left:10px"> Rs '+ price + '</h4>'
